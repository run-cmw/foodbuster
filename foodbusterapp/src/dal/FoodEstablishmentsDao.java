...
/**
 * Data access object (DAO) class to interact with the underlying FoodEstablishments table in your MySQL
 * instance. This is used to store {@link FoodEstablishments} into your MySQL instance and retrieve 
 * {@link FoodEstablishments} from MySQL instance.
 */
public class FoodEstablishmentsDao {
	...
	/**
	 * Save the FoodEstablishments instance by storing it in your MySQL instance.
	...
	/**
	 * Delete the FoodEstablishments instance.
	...
	public FoodEstablishments deleteByName(String estabName) throws SQLException {
		...
		try {
			...
			// Return null so the caller can no longer operate on the FoodEstablishments instance.
			return null;
		} catch (SQLException e) {
			e.printStackTrace();
			throw e;
